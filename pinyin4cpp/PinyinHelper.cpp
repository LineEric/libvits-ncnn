...
*
*/
void PinyinHelper::toHanyuPinyinStringArray(wchar_t  ch, HanyuPinyinOutputFormat *outputFormat, vector<wstring>*pinyinList)
{
 ...
 *         numbers; return list size equal zero for non-Chinese character
 */
void  PinyinHelper::getFormattedHanyuPinyinStringArray(wchar_t  ch, HanyuPinyinOutputFormat *outputFormat, vector<wstring>*pinyinList)
{
    if((NULL==outputFormat)||(NULL==pinyinList)){
        return;
    }
...
void  PinyinHelper::getUnformattedHanyuPinyinStringArray(wchar_t  ch, vector<wstring>*pinyinList)
{
